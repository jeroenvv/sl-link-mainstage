...
# what it drives and Scripts/run-codec-tests.sh for the equivalent on the
# Swift side (this script mirrors its shape deliberately).
#
...
#      byte vectors were cross-checked by hand against SL-Link-Mainstage/
#      SLLink/SLLinkEncoder.swift with:
...
#      (main.swift printing hex for id1=SL_HOST_ID, id2=SL_INSTANCE_START) -
